...
class Settings(BaseModel):
    ...
    DEFAULT_MODEL_ID: str = Field(default="gpt-4o-mini")  # example default
    ...
    # Optional tracing / telemetry toggles (Agno has its own too)
    ENABLE_TRACING: bool = Field(default=False)

    @staticmethod
    def load(prefix: str = "") -> "Settings":
        # Load from environment variables (simple, explicit mapping)
        env = os.environ
        data = {}
        ...
        data["SHOW_TOOL_CALLS"] = get_bool("SHOW_TOOL_CALLS", True)
